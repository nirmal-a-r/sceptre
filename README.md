...
in **five-area** Load Frequency Control — in one notebook.
...
[![Notebook](https://img.shields.io/badge/notebook-74%20cells-F37626?logo=jupyter&logoColor=white)](SCEPTRE.ipynb)
[![Figures](https://img.shields.io/badge/figures-22-8A2BE2)](figures/)
...
is — so the theory predicts *no* structural advantage there, and the benchmark duly
shows SCEPTRE tied with three baselines on that system.
...
All 22 are regenerated by a single Run All, as PNG **and** PDF.
